...
def create_list(arg1, arg2 = None, arg3 = None):
    """This function used to create an example list. This list will be used in main() function"""
    example_list = []
...
def main():
    ...
    test (create_list(1, 10, 2),
          [1, 3, 5, 7, 9])
    test (create_list(1, 6),
          [1, 2, 3, 4, 5])
    test (create_list(5),
          [0, 1, 2, 3, 4])
    test (create_list(5, -1, -2),
          [5, 3, 1])
    test (create_list(-10, -3, 2),
          [-10, -8, -6, -4])
    test (create_list(-10, -5),
          [-10, -9, -8, -7, -6])
